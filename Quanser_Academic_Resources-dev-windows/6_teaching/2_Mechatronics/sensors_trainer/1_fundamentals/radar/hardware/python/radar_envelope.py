# Radar Envlope Mode Experiment
# In this script, the sensor trainer is configure to run the Radar sensor in 
# "envelope" mode, and the receved data will be plotted and displayed to facilitate
# lab activities.
...
# setup parameters
simulationTime = 1000 # will run for 1000 seconds
frequency = 100 # Hz
